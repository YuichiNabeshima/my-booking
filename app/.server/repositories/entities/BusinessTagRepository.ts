...
@injectable()
export class BusinessTagRepository extends BaseRepository<
  {
...
> implements IBusinessTagRepository {
  constructor(
    @inject(GLOBAL_DI_TYPES.TransactionManager) transactionManager: ITransactionManager<Record<PascalToCamelCase<Prisma.ModelName>, Prisma.BusinessTagDelegate>>,
  ) {
    super({
