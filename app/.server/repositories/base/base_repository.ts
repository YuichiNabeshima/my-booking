...
import type { IBaseRepository } from "./i_base_repository";
...
export abstract class BaseRepository<
  ...
  CreateInput,
  UpdateInput,
  TModelDelegate extends ModelDelegate<TModel, WhereInput, WhereUniqueInput, CreateInput, UpdateInput>
> implements IBaseRepository<TModel, WhereInput, WhereUniqueInput, CreateInput, UpdateInput> {
