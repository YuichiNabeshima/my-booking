...
import { BookingCapacityManager } from "./BookingCapacityManager";

export class BookingAvailabilityChecker {
  private bookingTracker: BookingTracker;
  private bookingCapacityManager: BookingCapacityManager;

  constructor(bookingTracker: BookingTracker, bookingCapacityManager: BookingCapacityManager) {
