  ...
  const hoursByDay = Object.keys(DAY_OF_WEEK).map((day) => {
    ...
    return {
      ...
      hours: dayHours.sort((a, b) => {
        // Sort by hours_kind
        const kindOrder = { [Object.keys(BUSINESS_HOURS_KIND)[0]]: 0, [Object.keys(BUSINESS_HOURS_KIND)[0]]: 1, [Object.keys(BUSINESS_HOURS_KIND)[2]]: 2, [Object.keys(BUSINESS_HOURS_KIND)[3]]: 3, [Object.keys(BUSINESS_HOURS_KIND)[4]]: 4 }
